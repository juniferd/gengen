...
const material = new THREE.MeshPhongMaterial( { color: 'rgb(255,0,255)', emissive: 0x440000, flatShading: true, shininess: 0  }  );
const material1 = new THREE.MeshPhongMaterial( { color: 'rgb(255,0,255)', emissive: 0x440000, flatShading: true, shininess: 0  }  );
const material2 = new THREE.MeshPhongMaterial( { color: 'rgb(255,0,255)', emissive: 0x440000, flatShading: true, shininess: 0  }  );
